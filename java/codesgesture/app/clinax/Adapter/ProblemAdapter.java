...
import codesgesture.app.clinax.ActivityAllHPDoctors;
...
public class ProblemAdapter extends RecyclerView.Adapter<ProblemAdapter.ViewHolder> {
    private ArrayList<HProblemModel> arrayList;
    private Context context;
    String Userid="";
    private int layout;
    String s,sm;

    public ProblemAdapter(Context context, ArrayList<HProblemModel> arrayList, int layout) {
    ...
    @Override
    public void onBindViewHolder(final ProblemAdapter.ViewHolder holder, final int i) {
        final HProblemModel data = arrayList.get(i);

        Uri uri = Uri.parse(sm+data.getSymptoms_icon());
        Glide.with(context).load(uri).into(holder.img);

        holder.nm.setText(data.getSymptoms_name());

        holder.btbook.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, ActivityAllHPDoctors.class);
    ...
    public void updateList(ArrayList<HProblemModel> list) {
        arrayList = list;
