package codesgesture.app.clinax.Utils;
...
public class ZProgressHUD extends Dialog {
    ...
    public ZProgressHUD(Context context) {
        ...
        view = getLayoutInflater().inflate(R.layout.progess, null);
        ...
        ivProgressSpinner = (ProgressBar) view.findViewById(R.id.imageview_progress_spinner);
...
//                break;
//            case 1:
        //ivProgressSpinner.setImageResource(R.drawable.ic_otp);
//                break;
//            case 2:
