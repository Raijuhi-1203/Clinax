...
public class PageDoctors extends AppCompatActivity {
    UserModel userModel;
    String s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(PageDoctors.this, 1);
        rvdoctors.setLayoutManager(mLayoutManager);
        doctorAdapter = new DoctorAdapter(PageDoctors.this, doctorModels, R.layout.item_doctor);
    ...
    private void GetDoctor() {
        ...
        CallJson jc = new CallJson(PageDoctors.this);
