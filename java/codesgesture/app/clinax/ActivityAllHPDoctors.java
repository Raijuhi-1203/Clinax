...
public class ActivityAllHPDoctors extends AppCompatActivity {
    HProblemModel hProblemModel;
    UserModel userModel;
    String s;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hProblemModel=(HProblemModel)getIntent().getSerializableExtra("data");
        ...
        GridLayoutManager mLayoutManager = new GridLayoutManager(ActivityAllHPDoctors.this, 1);
        rvdoctors.setLayoutManager(mLayoutManager);
        doctorAdapter = new DoctorAdapter(ActivityAllHPDoctors.this, doctorModels, R.layout.item_doctor);
    ...
    private void GetDoctor() {
        ...
        CallJson jc = new CallJson(ActivityAllHPDoctors.this);
        param.add(new NetParam("symptoms_check",hProblemModel.getSymptoms_name()));
        param.add(new NetParam("cdate",cdate));
        param.add(new NetParam("cday",cday));
        jc.SendRequest(s,"get_symtomps_doctors", param, new JsonCallbacks() {
            @Override
